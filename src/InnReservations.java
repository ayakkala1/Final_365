...
public class InnReservations {
    ...
    private void roomRates(){
        try {
            ...
            System.out.println("===========================================================================================================================================================================");
            System.out.format("|| %4s | %30s | %12s | %12s | %12s | %17s | %4s | %10s | %7s | %7s | %12s | %5s ||%n", rsmd.getColumnName(1),
            ...
            while (rs.next()) {
                ...
                System.out.format("|| %4s | %30s | %12s | %12s | %12s | %17s | %4s | %10s | %7s | $%6.2f | %12s | %.2f  ||%n", Room, RoomName, lastCheckIn,lastCheckOut,recentLength,nextAvailability,Beds,bedType,maxOcc,basePrice,decor, proportion_last_180_days);
            }
            System.out.println("===========================================================================================================================================================================");
            return;
        }
